...
$("#chat-toggle").on("click", function() {
  ...
  $(this)
    .siblings("#chat-container")
    .slideToggle();
  $(this)
    .children(".fa")
    .toggleClass("fa-comment fa-times");
});

$("#chat-question-preview").on("click", function() {
  $("#chat-notification")
    .children(".chat-header-container")
    .slideUp();
  $("#chat-notification")
    .children(".form-notification")
    .slideDown();
...
$("#chat-container .chat-header-container").on("click", function(e) {
  ...
  if (
    $(e.target).hasClass("btnBack") ||
    $(e.target).hasClass("fa fa-chevron-left")
  ) {
    ...
    $("#chat-container")
      ...
      .addClass("shrinked");
    $(this)
      .prevAll(".chat-header-container")
      .slideToggle();
    $(this)
      .nextAll(".chat-header-container")
      .slideToggle();
    $(this)
      .siblings(".chat-header-intro")
      .slideToggle();
    $(this)
      .siblings(".chat-body-container, .chat-input-container")
      .slideUp();
    $(this)
      .siblings(".chat-body-container, .chat-input-container")
      .hide();
  ...
  if (
    ...
    $(e.target).hasClass("fa fa-video-camera")
  ) {
    console.log("oops");
    $("#chat-container")
      .children(".chat-video-container")
      .slideDown();
    $("#chat-container")
      .children(".chat-video-container")
      .siblings()
  ...
  $(this)
    .siblings(".chat-header-container")
    .slideUp();
  $(this)
    .siblings(".chat-body-container, .chat-input-container")
    .removeClass("hide");
...
$("#btnSend").on("click", function() {
  ...
  $(this)
    .parents(".chat-input-container")
    .animate({ height: "63px" }, 400);
  $(this)
    .parent(".chat-input")
    .prev(".attachments")
    .slideUp();
  $(this)
    .parents(".chat-input-container")
    .siblings(".chat-body-container")
    .slideDown();
  $(this)
    .parents(".chat-input-container")
    .siblings(".chat-body-container")
    .animate({ height: "406px" }, 400);
});
...
$("#chat-video-compress").on("click", function() {
  ...
  $("#chat-container")
    ...
    .slideDown();
  $("#chat-container")
    .children(".chat-header-intro")
    .hide();
  $("#chat-container")
    .children(".chat-header-container:first")
    .children(".chat-header")
    .removeClass("shrinked active");
  $("#chat-container")
    .children(".chat-header-container:first")
...
$("#chat-video-message").on("click", function() {
  ...
  if (
    ...
    $("#chat-container")
      .find("#videos")
      .animate({ height: "600px" }, 400);
  } else {
    $("#chat-container")
      .children(".chat-video-container")
      .animate({ height: "90%" }, 400);
    $("#chat-container")
      .find("#videos")
      .animate({ height: "540px" }, 400);
  }
  $("#chat-container")
...
$(".editor-content").on("click", ".input-group-button .button", function(e) {
  e.preventDefault();
  val = $(this)
    .parent(".input-group-button")
    .siblings(".input-group-field");
  if (!val.val()) {
    return;
  }
  $(this)
    ...
    .siblings("ul")
    .append(
      '<li><div class="input-group bg-black10 mb-0"><input class="input-group-field" type="text" value="' +
        val.val() +
        '"><div class="input-group-button"><button class="button success borderless hollow clear alert remove"><i class="fa fa-times"></i></button></div></div></li>'
    );
  val.val("");
  val.focus();
});
...
$(".clinical-pathway-basic-content").on("click", function() {
  $(this)
    .parents(".clinical-pathway-item")
    .siblings(".clinical-pathway-item")
    .find(".clinical-pathway-details")
    .slideUp();
  $(this)
    .siblings(".clinical-pathway-details")
    .slideDown();
});

$(".clinical-pathway-new-entry-list").children("selector");

$(".clinical-pathway-new-entry-list").on(
  "click",
  ".clinical-pathway-new-entry",
  function(e) {
    e.preventDefault();
    $(this)
      .siblings()
...
selectOnClick(
  ".ul-tree-child",
  ".ul-tree, .ul-tree-only-child-selectable",
  "selected"
);
...
$(".repositioned").each(function(index, el) {
  ...
  if ($(this).data("position-top")) {
    $(this)
      .children(".repositioned-container")
      .css("top", $(this).data("position-top"));
  }
  if ($(this).data("position-right")) {
    $(this)
      .children(".repositioned-container")
      .css("right", $(this).data("position-right"));
  }
...
var myLinks = [
  "advocate-employee-episode.html",
  "advocate-employee-progile.html",
  "advocate-employee-HSA.html"
];

function makeLink(location, file) {
...
var apiKey = "45907482";
var sessionId =
  "2_MX40NTkwNzQ4Mn5-MTQ5OTE1NzY3NTE1NX5Ob3BVZERRSmkwUHpwWFB1dDdlRW0vRG5-fg";
var token =
  "T1==";
...
var ctx = document.getElementById("chartUsage2").getContext("2d");
var chart = new Chart(ctx, {
  // The type of chart we want to create
  type: "bar",
...
var ctx = document.getElementById("chartCost2").getContext("2d");
var chart = new Chart(ctx, {
  // The type of chart we want to create
  type: "bar",
